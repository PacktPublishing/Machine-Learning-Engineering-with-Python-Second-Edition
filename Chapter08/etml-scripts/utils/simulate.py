...
def simulate_text_data():
    example_news = f'''
    There is a traffic jam on the M8 motorway near Glasgow. 
    Reports are that there has been an accident due to icy conditions on the roads. 
    No one has been seriously injured but the road is blocked and traffic is backed up for miles.
    '''
    
    example_weather = f'''
    The forecast for the West of Scotland over the next
    '''
